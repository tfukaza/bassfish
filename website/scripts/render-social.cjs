...
(async () => {
  ...
  try {
    ...
    await page.evaluate(async () => {
      ...
      card.className = 'share-brand';
      card.innerHTML =
        '<div class="share-wordmark"><img src="./assets/icon.svg" alt=""><span>bassfish</span></div><p></p><span class="share-address">tfukaza.github.io/bassfish</span>';
    ...
    const output = path.resolve(__dirname, '../assets/bassfish-team-social-v2.jpg');
