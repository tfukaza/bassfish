...
Run connection commands only for the host the user uses. Preserve other MCP server settings when editing configuration.
...
The skills provide guidance. They do not replace the MCP connection configured above.
